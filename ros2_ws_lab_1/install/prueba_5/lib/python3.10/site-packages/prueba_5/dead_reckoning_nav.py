...
class DeadReckoningNav(Node):
    ...
    def aplicar_velocidad(self, speed_command_list, id=None): #mandar velocidades y angulos al robot
        ...
        # if speed_command_list[2] != 0:
        #     print(self.orientacion_actual, id)
...
#keyboard teleop
    ...
    def registrar_odom(self, msg):
        datos = msg
        self.camino_odom.append(datos)
        print("camino odom", datos.pose.pose.position)

    def registrar_pos_real(self, msg):
        datos = msg
        self.camino_real.append(datos)
        print("camino real", datos.position)
...
class Graficador(Node):
    ...
    def graficar(self, msg):
        ...
        # Subplot para posiciones reales
        plt.subplot(1, 2, 2)
